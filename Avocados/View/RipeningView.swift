    ...
    var body: some View {
        VStack {
            Image(ripening.image)
                ...
                .background(
                 Circle()
                    .fill(Color("ColorApprearenceAdaptive"))
                    .frame(width: 110, height: 110, alignment: .center)
                )
                .zIndex(1)
            ...
            VStack(alignment: .center, spacing: 10) {
                ...
                Text(ripening.title)
                    ...
                    RoundedRectangle(cornerRadius: 12)
                        ...
                        .shadow(color: Color("ColorBlackTransparentLight"), radius: 6, x: 8, y: 6))
                ...
                Text(ripening.ripeness)
                    ...
                    .background(
                    RoundedRectangle(cornerRadius: 12)
                        .fill(LinearGradient(gradient: Gradient(colors: [Color("ColorGreenMedium")]), startPoint: .top, endPoint: .bottom))
